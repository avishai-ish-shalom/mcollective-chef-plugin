# harvested from https://github.com/opscode-cookbooks/partial_search/raw/master/libraries/partial_search.rb
...
#     end
#
module ChefPartialSearchMixin
  def partial_search(type, query='*:*', args_hash={}, &block)
